	...
	var errors=0;
	 ...
	 if($j('#contactform #name').val()=='') {
		...
		var hasClass=$j('#contactform #email').parent().find(".error").hasClass("error");
	 	if(!hasClass)
	 	    $j('#contactform #email').parent().append('<label for="contactname" generated="true" class="error">Veuillez entrer une adresse valide</label>');	
	...
	var errors=0;
	 ...
	 if($j('#contactform_booking #name').val()=='') {
		...
		var hasClass=$j('#contactform_booking #email').parent().find(".error").hasClass("error");
	 	if(!hasClass)
	 	    $j('#contactform_booking #email').parent().append('<label for="contactname" generated="true" class="error">Veuillez entrer une adresse valide</label>');	
	...
	var errors=0;
	 ...
	 if($j('#contactform_popup #name_popup').val()=='') {
		...
		var hasClass=$j('#contactform_popup #email_popup').parent().find(".error").hasClass("error");
	 	if(!hasClass)
	 	    $j('#contactform_popup #email_popup').parent().append('<label for="contactname" generated="true" class="error">Veuillez entrer une adresse valide</label>');	
	...
	var errors=0;
	 ...
	 if($j('#newsletterform #name_news').val()=='') {
		...
		var hasClass=$j('#newsletterform #email_news').parent().find(".error").hasClass("error");
	 	if(!hasClass)
	 	    $j('#newsletterform #email_news').parent().append('<label for="contactname" generated="true" class="error">Veuillez entrer une adresse valide</label>');	
